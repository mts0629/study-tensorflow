...
# create batches of 10000 examples
...
# plot the validation and training losses for the tiny model
plotter = tfdocs.plots.HistoryPlotter(metric='binary_crossentropy', smoothing_std=10)
plotter.plot(size_histories)
plt.ylim([0.5, 0.7])

# demonstrate with small model
...
# adopt L2 weight regularization
